...
//import edu.iastate.cs228.hw06.LListWithTail.Node;
...
public class LList<T> extends CustomClass<T>
{
   ...
   //               1 <= givenPosition <= numberOfEntries.	
	...
	public T getLast()
	{
		if(firstNode != null)
		{
			Node temp = this.getNodeAt(numberOfEntries);
			return temp.data;
		}
		else
			throw new NoSuchElementException();
	...
	{
		Node temp = new Node(this.removeFirst());
	...
	{
		int i = this.getPosition(anEntry);
		if(i != -1)
		{
			this.remove(i);
			return true;
	...
	public int getPosition(T anEntry)
	{
		if(firstNode != null)
		{
			Node currentNode = firstNode;
			int i = 1;
			while(i < numberOfEntries+1 && currentNode.data != anEntry)
			{
